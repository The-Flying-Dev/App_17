...
A console based To Do List Application.  In this program the user can add, remove and view items in the List.
The taskList DataType has been initialized with values.
The following topics are covered: `User Input`, `While loops`, `Conditional Statements`, `For/ForEach Loops` and `Lists`.
